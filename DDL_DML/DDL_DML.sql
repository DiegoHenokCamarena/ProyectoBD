...
drop table TELEFONOPROP CASCADE CONSTRAINTS;
drop table MASCOTA CASCADE CONSTRAINTS;
drop table CATALOGO CASCADE CONSTRAINTS;
drop table SERVICIO CASCADE CONSTRAINTS;
drop table CONSULTA CASCADE CONSTRAINTS;
drop table MEDICAMENTOS_CONSULTA CASCADE CONSTRAINTS;
drop table DESC_VACUNACION CASCADE CONSTRAINTS;
drop table VACUNACION CASCADE CONSTRAINTS;
drop table DESC_DESPARACITANTE CASCADE CONSTRAINTS;
drop table DESPARACITACION CASCADE CONSTRAINTS;
drop table DESC_INTERNAMIENTO CASCADE CONSTRAINTS;
drop table INTERNAMIENTO CASCADE CONSTRAINTS;
drop table EMPLEADO CASCADE CONSTRAINTS;
drop table DATOS_MED CASCADE CONSTRAINTS;
drop table MEDICO CASCADE CONSTRAINTS;
drop table DATOS_CUI CASCADE CONSTRAINTS;
drop table CUIDADOR CASCADE CONSTRAINTS;
drop table TELEFONO_CUIDADOR CASCADE CONSTRAINTS;
drop table CUIDADORINTER CASCADE CONSTRAINTS;
drop table RECIBOFOLIO CASCADE CONSTRAINTS;
drop table RECIBO CASCADE CONSTRAINTS;
drop table PAGO CASCADE CONSTRAINTS;
drop table CLAVE_SERVICIO CASCADE CONSTRAINTS;
drop table SERVICIO_CONSULTA CASCADE CONSTRAINTS;
drop table DATOS_INTERNAMIENTO CASCADE CONSTRAINTS;
drop table MASCOTA_SERVICIO CASCADE CONSTRAINTS;
drop table MEDICAMENTO CASCADE CONSTRAINTS;
drop table CONS_MEDI CASCADE CONSTRAINTS;
drop table INTER_MEDI CASCADE CONSTRAINTS;
