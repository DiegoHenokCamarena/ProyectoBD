...
CREATE TABLE MASCOTA_SERVICIO (
    ...
    CONSTRAINT FK_CLVSERV FOREIGN KEY (CLAVESERV) REFERENCES SERVICIO(CLAVESERV) ON DELETE CASCADE,
    CONSTRAINT FK_CLVMASC FOREIGN KEY (CLAVEMASCOTA) REFERENCES MASCOTA(CLAVEMASCOTA) ON DELETE CASCADE
);
